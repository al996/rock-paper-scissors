	...
	public static void main(String[] args) {
		...
		do
		{
			...
			do
			{
				...
				//Run if Player only needs to win one more round to win the game
					//Prevents Computer from losing
				if(playerScore == WINSCORE - 1)
				{
					//Run if Player Choice is Rock
					if(playerChoice == ROCK)
					{
						//Could use while loop instead of if and do while
						//Run if Computer Choice is Scissors
						if(computerChoice == SCISSORS)
						{
							//Change Computer Choice randomly until not Scissors
							do
							{
								computerChoice = (int)(Math.random() * NUMCHOICES + FIRSTCHOICE);
					...
					//Run if Player Choice is Paper
					else if(playerChoice == PAPER)
					{
						//Run if Computer Choice is Rock
						if(computerChoice == ROCK)
						{
							//Change Computer Choice randomly until not Rock
							do
							{
								computerChoice = (int)(Math.random() * NUMCHOICES + FIRSTCHOICE);
					...
					//Run if Player Choice is Scissors
					else if(playerChoice == SCISSORS)
					{
						//Run if Computer Choice is Paper
						if(computerChoice == PAPER)
						{
							//Change Computer Choice randomly until not Paper
							do
							{
								computerChoice = (int)(Math.random() * NUMCHOICES + FIRSTCHOICE);
				...
				//Run if Player needs to win more than one more round to win the game
				//Non-cheater play
				else
				{
					//Prints Computer's corresponding string to int value
			...
			//Winner
			//Computer wins, Player can't win
